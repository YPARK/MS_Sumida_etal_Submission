...
```{r gene_data_removing_poor_qc_cells}
...
```{r Fig_svd_batch, fig.width=4, fig.height=4}
...
```{r Fig_svd_batch_filtered, fig.width=4, fig.height=4}
...
```{r echo=F, results="asis"}
.file <- fig.dir %&% "/Fig_svd_batch_filtered.pdf"
.gg.save(filename = .file, plot = plt, width=4, height=4)
```
...
```{r Fig_gene_qc, fig.width = 4, fig.height = 4}
