...
```{r Fig_mtconv_gene_scores, fig.width=8, fig.height=3}
...
```{r include = F}
.add <- c("CD279","PDCD1","LAG3","CD223","HAVCR2","TIM3","CD366","TOX","TOX2", "SGK1", "FOXP3")
...
```{r Fig_mTconv_DEG_example2, include = FALSE}
.mkdir(fig.dir %&% "/example/")
...
```{r Tab_mTconv_DEG_extra, results="asis", echo = FALSE}
fig.hdr <- fig.dir %&% "/example/Fig_mTconv_DEG_example_"
...
```{r Fig_mtreg_gene_scores, fig.width=8, fig.height=3}
.genes.interest <- c("PRDM1", "SGK1", "LBH", "DDIT4")
...
```{r include = F}
.add <- c("CD279","PDCD1","LAG3","CD223","HAVCR2",
          "TIM3","CD366","TOX","TOX2", "SGK1", "FOXP3",
          "CD27", "CD28", "TRAF3IP3")
...
```{r Fig_mTreg_DEG_example2, include = FALSE}
.mkdir(fig.dir %&% "/example/")
for(g in additional.genes){
    .file <- fig.dir %&% "/example/Fig_mTreg_DEG_example_" %&% g %&% ".pdf"
   if.needed(.file, {
...
```{r Tab_mTreg_DEG_extra, results="asis", echo = FALSE}
fig.hdr <- fig.dir %&% "/example/Fig_mTreg_DEG_example_"
deg.tab <- hc.ms.deg[gene %in% additional.genes]
